...
### 3. Apply the Kubernetes manifests
    ...
    Make sure you are in root of your project folder, not in terraform
    kubectl apply -f ./manifests/       # This will install both deployment.yaml and service.yaml

### 4. Install and deploy ArgoCD
